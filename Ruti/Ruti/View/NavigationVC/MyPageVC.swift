...
class MyPageVC: UIViewController {
    ...
    func setUI() {
        ...
        attributeString.addAttribute(.foregroundColor, value: UIColor.init(hexCode: "#FFBA58"), range: (text as NSString).range(of: "\(level)"))
        ...
        attributeString2.addAttribute(.foregroundColor, value: UIColor.init(hexCode: "#FEE500"), range: (text as NSString).range(of: "\(socialType)"))
        ...
        imgBaseView.layer.borderColor = UIColor(hexCode: "B5DCFF").cgColor
